...
########################################################
# This file teaches                                    #
# 1. how to connect to the remote github               #
# 2. how to create different branches                  #
...
git push -u origin try3 # create try3 branch in remote repo, and connect the local try3 branch to the remote try3 branch; push the local to there
